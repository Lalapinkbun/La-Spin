...
7. **The Highest Possible** → get the highest L Coin without getting from the same shape  
Well, I guess it's still much huh?

8. **The Lowest Possible** -> get the lowest L Coin without getting from the same shape on the 3-column slot or above  
bad luck bro.
